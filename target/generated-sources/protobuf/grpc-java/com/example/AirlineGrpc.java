...
public final class AirlineGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.example.CancelFlightRequest,
      com.example.CancelFlightResponse> getCancelFlightMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "CancelFlight",
      requestType = com.example.CancelFlightRequest.class,
      responseType = com.example.CancelFlightResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.example.CancelFlightRequest,
      com.example.CancelFlightResponse> getCancelFlightMethod() {
    io.grpc.MethodDescriptor<com.example.CancelFlightRequest, com.example.CancelFlightResponse> getCancelFlightMethod;
    if ((getCancelFlightMethod = AirlineGrpc.getCancelFlightMethod) == null) {
      synchronized (AirlineGrpc.class) {
        if ((getCancelFlightMethod = AirlineGrpc.getCancelFlightMethod) == null) {
          AirlineGrpc.getCancelFlightMethod = getCancelFlightMethod =
              io.grpc.MethodDescriptor.<com.example.CancelFlightRequest, com.example.CancelFlightResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "CancelFlight"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.CancelFlightRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.CancelFlightResponse.getDefaultInstance()))
              .setSchemaDescriptor(new AirlineMethodDescriptorSupplier("CancelFlight"))
              .build();
        }
      }
    }
    return getCancelFlightMethod;
  }
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void cancelFlight(com.example.CancelFlightRequest request,
        io.grpc.stub.StreamObserver<com.example.CancelFlightResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getCancelFlightMethod(), responseObserver);
    }
  }
  ...
  public static final class AirlineStub
    ...
    /**
     */
    public void cancelFlight(com.example.CancelFlightRequest request,
        io.grpc.stub.StreamObserver<com.example.CancelFlightResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getCancelFlightMethod(), getCallOptions()), request, responseObserver);
    }
  }
  ...
  public static final class AirlineBlockingV2Stub
    ...
    /**
     */
    public com.example.CancelFlightResponse cancelFlight(com.example.CancelFlightRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
          getChannel(), getCancelFlightMethod(), getCallOptions(), request);
    }
  }
  ...
  public static final class AirlineFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.example.CancelFlightResponse> cancelFlight(
        com.example.CancelFlightRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
          getChannel().newCall(getCancelFlightMethod(), getCallOptions()), request);
    }
  }

  private static final int METHODID_BOOK_FLIGHT = 0;
  private static final int METHODID_CANCEL_FLIGHT = 1;
      ...
      switch (methodId) {
        case METHODID_BOOK_FLIGHT:
          serviceImpl.bookFlight((com.example.FlightRequest) request,
              (io.grpc.stub.StreamObserver<com.example.FlightResponse>) responseObserver);
          break;
        case METHODID_CANCEL_FLIGHT:
          serviceImpl.cancelFlight((com.example.CancelFlightRequest) request,
              (io.grpc.stub.StreamObserver<com.example.CancelFlightResponse>) responseObserver);
          break;
        default:
  ...
  public static final io.grpc.ServerServiceDefinition bindService(AsyncService service) {
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        ...
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.example.CancelFlightRequest,
              com.example.CancelFlightResponse>(
                service, METHODID_CANCEL_FLIGHT)))
        .build();
  }
      ...
      synchronized (AirlineGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              ...
              .addMethod(getCancelFlightMethod())
              .build();
        }
      }
    }
