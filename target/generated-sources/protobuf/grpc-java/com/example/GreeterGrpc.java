...
public final class GreeterGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.example.HelloRequest,
      com.example.HelloReply> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHello",
      requestType = com.example.HelloRequest.class,
      responseType = com.example.HelloReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.example.HelloRequest,
      com.example.HelloReply> getSayHelloMethod() {
    io.grpc.MethodDescriptor<com.example.HelloRequest, com.example.HelloReply> getSayHelloMethod;
    if ((getSayHelloMethod = GreeterGrpc.getSayHelloMethod) == null) {
      synchronized (GreeterGrpc.class) {
        if ((getSayHelloMethod = GreeterGrpc.getSayHelloMethod) == null) {
          GreeterGrpc.getSayHelloMethod = getSayHelloMethod =
              io.grpc.MethodDescriptor.<com.example.HelloRequest, com.example.HelloReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.HelloReply.getDefaultInstance()))
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void sayHello(com.example.HelloRequest request,
        io.grpc.stub.StreamObserver<com.example.HelloReply> responseObserver) {
  ...
  public static final class GreeterStub
     ...
     * </pre>
     */
    public void sayHello(com.example.HelloRequest request,
        io.grpc.stub.StreamObserver<com.example.HelloReply> responseObserver) {
  ...
  public static final class GreeterBlockingV2Stub
     ...
     * </pre>
     */
    public com.example.HelloReply sayHello(com.example.HelloRequest request) {
  ...
  public static final class GreeterFutureStub
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.example.HelloReply> sayHello(
        com.example.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((com.example.HelloRequest) request,
              (io.grpc.stub.StreamObserver<com.example.HelloReply>) responseObserver);
          break;
        default:
