...
public final class CarRentalGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.example.CancelCarRequest,
      com.example.CancelCarResponse> getCancelCarMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "CancelCar",
      requestType = com.example.CancelCarRequest.class,
      responseType = com.example.CancelCarResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.example.CancelCarRequest,
      com.example.CancelCarResponse> getCancelCarMethod() {
    io.grpc.MethodDescriptor<com.example.CancelCarRequest, com.example.CancelCarResponse> getCancelCarMethod;
    if ((getCancelCarMethod = CarRentalGrpc.getCancelCarMethod) == null) {
      synchronized (CarRentalGrpc.class) {
        if ((getCancelCarMethod = CarRentalGrpc.getCancelCarMethod) == null) {
          CarRentalGrpc.getCancelCarMethod = getCancelCarMethod =
              io.grpc.MethodDescriptor.<com.example.CancelCarRequest, com.example.CancelCarResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "CancelCar"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.CancelCarRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.CancelCarResponse.getDefaultInstance()))
              .setSchemaDescriptor(new CarRentalMethodDescriptorSupplier("CancelCar"))
              .build();
        }
      }
    }
    return getCancelCarMethod;
  }
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void cancelCar(com.example.CancelCarRequest request,
        io.grpc.stub.StreamObserver<com.example.CancelCarResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getCancelCarMethod(), responseObserver);
    }
  }
  ...
  public static final class CarRentalStub
    ...
    /**
     */
    public void cancelCar(com.example.CancelCarRequest request,
        io.grpc.stub.StreamObserver<com.example.CancelCarResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getCancelCarMethod(), getCallOptions()), request, responseObserver);
    }
  }
  ...
  public static final class CarRentalBlockingV2Stub
    ...
    /**
     */
    public com.example.CancelCarResponse cancelCar(com.example.CancelCarRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
          getChannel(), getCancelCarMethod(), getCallOptions(), request);
    }
  }
  ...
  public static final class CarRentalFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.example.CancelCarResponse> cancelCar(
        com.example.CancelCarRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
          getChannel().newCall(getCancelCarMethod(), getCallOptions()), request);
    }
  }

  private static final int METHODID_BOOK_CAR = 0;
  private static final int METHODID_CANCEL_CAR = 1;
      ...
      switch (methodId) {
        case METHODID_BOOK_CAR:
          serviceImpl.bookCar((com.example.CarRequest) request,
              (io.grpc.stub.StreamObserver<com.example.CarResponse>) responseObserver);
          break;
        case METHODID_CANCEL_CAR:
          serviceImpl.cancelCar((com.example.CancelCarRequest) request,
              (io.grpc.stub.StreamObserver<com.example.CancelCarResponse>) responseObserver);
          break;
        default:
  ...
  public static final io.grpc.ServerServiceDefinition bindService(AsyncService service) {
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        ...
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.example.CancelCarRequest,
              com.example.CancelCarResponse>(
                service, METHODID_CANCEL_CAR)))
        .build();
  }
